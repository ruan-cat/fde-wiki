...
const GEN = path.resolve(DOCS, '.vitepress/generated.ts');
...
// 标签→类别映射,与 docs/.vitepress/theme/index.ts 的 TAG_CAT 保持一致(徽章五色同源)
const TAG_CAT = {
...
// 标签 slug(与 index.ts 的 slugifyTag 一致,确保页顶徽章 / 标签云 / 标题锚点三处跳转统一)
...
fs.writeFileSync(
  GEN,
  '// AUTO-GENERATED by scripts/split.mjs — 请勿手改。改章节结构后重跑 pnpm split。\n' +
